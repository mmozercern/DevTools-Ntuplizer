...
submit_job.py crabSubmit --sampleList DevTools/Ntuplizer/data/datasetList_Data.txt --applyLumiMask "Collisions15" "$DATE"_"$NAME" DevTools/Ntuplizer/test/MiniTree_cfg.py runMetFilter=1
