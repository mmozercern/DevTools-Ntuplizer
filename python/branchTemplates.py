...
triggerBranches = cms.PSet(
    ...
    # double muon
    Mu17_TrkIsoVVL_Mu8_TrkIsoVVL_DZ             = cms.PSet( path  = cms.string('HLT_Mu17_TrkIsoVVL_Mu8_TrkIsoVVL_DZ_v\\[0-9]+'), ),
    Mu17_TrkIsoVVL_TkMu8_TrkIsoVVL_DZ           = cms.PSet( path  = cms.string('HLT_Mu17_TrkIsoVVL_TkMu8_TrkIsoVVL_DZ_v\\[0-9]+'), ),
    # double electron
    Ele17_Ele12_CaloIdL_TrackIdL_IsoVL_DZ       = cms.PSet( path  = cms.string('HLT_Ele17_Ele12_CaloIdL_TrackIdL_IsoVL_DZ_v\\[0-9]+'), ),
    # electron muon
    ...
    # muon tau
    IsoMu17_eta2p1_LooseIsoPFTau20              = cms.PSet( path  = cms.string('HLT_IsoMu17_eta2p1_LooseIsoPFTau20_v\\[0-9]+'), ),
    IsoMu20_eta2p1_LooseIsoPFTau20              = cms.PSet( path  = cms.string('HLT_IsoMu20_eta2p1_LooseIsoPFTau20_v\\[0-9]+'), ),
    # electron tau
    Ele22_eta2p1_WPLoose_Gsf_LooseIsoPFTau20    = cms.PSet( path  = cms.string('HLT_Ele22_eta2p1_WPLoose_Gsf_LooseIsoPFTau20_v\\[0-9]+'), ),
    Ele27_eta2p1_WPLoose_Gsf_LooseIsoPFTau20    = cms.PSet( path  = cms.string('HLT_Ele27_eta2p1_WPLoose_Gsf_LooseIsoPFTau20_v\\[0-9]+'), ),
    # triple lepton
